...
module.exports = (sequelize, DataTypes) => {
  ...
  materia.associate = function(models) {
    ...
    materia.belongsTo(models.profesor,   // modelo al que pertenece
      ...
      /*
      materia.belongsTo(models.nota,    // ME FALTA EL ID_NOTA EN LA TABLA MATERIA
        {
          as : 'Nota-Relacionada',     // nombre de mi relacion
          foreignKey: 'id_nota'        // campo con el que voy a igualar
        })
      */  
  };
  return materia;
